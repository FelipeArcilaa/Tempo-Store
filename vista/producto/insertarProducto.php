...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-10 offset-md-1">
                ...
                try {
                    if (!isset($_REQUEST["identificacion"])) {
                        throw new PDOException("Por favor digite la identificación del producto");
                    }
                    if (!isset($_REQUEST["nombre"])) {
                        throw new PDOException("Por favor digite el nombre del producto");
                    }
                    if (!isset($_REQUEST["descripcion"])) {
                        throw new PDOException("Por favor digite la descripcion del producto");
                    }
                    if (!isset($_REQUEST["unidades"])) {
                        throw new PDOException("Por favor digite las unidades del producto");
                    }
            ...
            <div class="row">
                <div class="col">
                    <a class="btn btn-warning" href="listarProducto.php">Regresar al listado de productos</a>
                </div>
            </div>
        </div>
    </div>
